...
Реализовать статистическую выгрузку, запускающуюся по cron-рассписанию. Используя многопоточность, для каждого источника составить csv формата Тема,Количество новостей. Файл называть названием источника.
